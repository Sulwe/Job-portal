            ...
            <form onSubmit={handleSubmit(onSubmit)} className='space-y-5'>
                ...
                <div className='create-job-flex'>
                    ...
                    <div className='lg:w-1/2 w-full'>
                        ...
                        <input type="text" placeholder='$120k' defaultValue={maxPrice} {...register("maxPrice")} 
                        className='create-job-input'/>
                    </div>
                </div>  
                ...
                <div className='create-job-flex'>
                    ...
                    <div className='lg:w-1/2 w-full'>
                        ...
                        <input type="text" placeholder='Ex: Seattle' defaultValue={jobLocation} {...register("jobLocation")} 
                        className='create-job-input'/>
                    </div>
                </div> 
                ...
                <div className='create-job-flex'>
                    <div className='lg:w-1/2 w-full'>
                        ...
                        <input type="date" placeholder='Ex: 2023-11-23' defaultValue={postingDate} {...register("postingDate")} 
                        className='create-job-input'/>
                    </div>
                    <div className='lg:w-1/2 w-full'>
                ...
                <div className='create-job-flex'>
                    <div className='lg:w-1/2 w-full'>
                        ...
                        <input type="url" placeholder='Paste your company logo URL: https://weshare.com/img1' defaultValue={companyLogo} {...register("companyLogo")} 
                        className='create-job-input'/>
                    </div>
                    <div className='lg:w-1/2 w-full'>
