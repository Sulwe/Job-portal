  ...
  return (
    <div>
        <h3 className='text-lg font-bold mb-2 flex items center gap-2'>
            ...
            <p className='text-primary/75 text-base mb-4'>Enter your email 
            address to be notified when new positions are available.</p>
            ...
            <p className='text-primary/75 text-base mb-4'>Let us know about your professional 
            background and experience.</p>

            <div className='w-full space-y-4'>

                <input type='submit' value={"Upload your resume"} className='w-full block py-2 pl-3
                border focus:outline-none bg-blue rounded-sm text-white cursor-pointer font-semibold'/>
