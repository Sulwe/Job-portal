        ...
        <div className='max-w-screen-2x1 container mx-auto xl:px-24 px-4 md:py-20 py-14'>
            ...
            <form>
                <div className='flex justify-start md:flex-row flex-col md:gap-0 gap-4'>
                    <div className='flex md:rounded-s-md rounded shaddoe-sm ring-1 ring-inset ring-gray-300 
                    ...
                    <div className='flex md:rounded-s-none rounded shaddoe-sm ring-1 ring-inset ring-gray-300 
